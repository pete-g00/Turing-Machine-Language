 ...
 */
 export class CodePosition {
     ...
     */
    constructor(startLineNumber:number, endLineNumber:number, startColNumber:number, endColNumber:number) {
    ...
    public toString(): string {
        return `Ln ${this.startLineNumber+1}:${this.endLineNumber+1}, Col ${this.startColNumber+1}:${this.endColNumber+1}`;
    }
     ...
     */
    public static combine(startPosition:CodePosition, endPosition:CodePosition):CodePosition {
